...
If it is set in NPT\_NP, the expansion or shrinkage on designated lattice vector will only try to keep the normal stress in this direction to oscillate near the corresponding target stress component (which is the sum of external pressure and corresponding external stress component).
\end{block}
