...
typedef struct _SPARC_OBJ{
    ...
    double *ion_forces_fractional; // Ionic forces in fractional coordinates
    ...
    //Note that reciprocal lattice is stored as ColumnMajor (since original lattice is rowMajor), and it lacks a factor of 2\pi 
